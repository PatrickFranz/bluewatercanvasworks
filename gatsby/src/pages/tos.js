...
const TOS = ({ children }) => {
  return (
    <SectionContainer>
      <h2>Blue Water Canvas Works Terms of Service</h2>
      <h3>1. Terms</h3>
      <p>
      ...
      <ol type="a">
        <li>
          ...
          materials (information or software) on Blue Water Canvas Works'
          ...
          <ol type="i">
            ...
            <li>
              ...
              Blue Water Canvas Works' website;
            </li>
            <li>
        ...
        <li>
          ...
          restrictions and may be terminated by Blue Water Canvas Works at any
      ...
      <ol type="a">
        <li>
          The materials on Blue Water Canvas Works' website are provided on an
          'as is' basis. Blue Water Canvas Works makes no warranties, expressed
        ...
        <li>
          Further, Blue Water Canvas Works does not warrant or make any
      ...
      <h3>4. Limitations</h3>
      <p>
        In no event shall Blue Water Canvas Works or its suppliers be liable for
        any damages (including, without limitation, damages for loss of data or
        profit, or due to business interruption) arising out of the use or
        inability to use the materials on Blue Water Canvas Works' website, even
        if Blue Water Canvas Works or a Blue Water Canvas Works authorized
      ...
      <p>
        The materials appearing on Blue Water Canvas Works' website could
        include technical, typographical, or photographic errors. Blue Water
        Canvas Works does not warrant that any of the materials on its website
        are accurate, complete or current. Blue Water Canvas Works may make
        changes to the materials contained on its website at any time without
        notice. However Blue Water Canvas Works does not make any commitment to
        update the materials.
      </p>
      <h3>6. Links</h3>
      <p>
        Blue Water Canvas Works has not reviewed all of the sites linked to its
        website and is not responsible for the contents of any such linked site.
        The inclusion of any link does not imply endorsement by Blue Water
        Canvas Works of the site. Use of any such linked website is at the
        user's own risk.
      </p>
      <h3>7. Modifications</h3>
      <p>
        Blue Water Canvas Works may revise these terms of service for its
